...
function About({}: Props) {
  return (
    <div className="mx-auto max-w-7xl w-full flex flex-col  items-center justify-center space-y-4 ">
      ...
      <button className="w-fit px-8 text-xl font-semibold border-2 rounded-xl p-3 hover:text-[#586ff5f2] border-[#5865f2]">
        Currículo
      </button>
    </div>
  );
