...
function LinksDetailed() {
  return (
    <div className=" flex  w-full mx-auto justify-center gap-10 items-center">
      <AnimatedBtn
        target="_blank"
        href="https://www.github.com/pefelippe"
        className="flex flex-col gap-2 text-2xl p-8 px-12 items-center bg-[#272727] hover:bg-[#242424] rounded-3xl"
      >
        <>
