...
function LinksDetailed() {
  return (
    <div className=" flex  w-full mx-auto justify-center gap-6 items-center ">
      <AnimatedBtn
        target="_blank"
        href="https://www.github.com/pefelippe"
        className="flex flex-col gap-2 text-xl p-3 justify-center items-center bg-[#272727] hover:bg-[#222222] rounded-3xl"
      >
        <>
