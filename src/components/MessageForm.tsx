...
export default function MessageForm({}: Inputs) {
  ...
  return (
    <>
      <div
        id="toast-success"
        className="hidden flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800"
        role="alert"
      >
        ...
        <div className="ml-3 text-sm font-normal">Mensagem enviada!</div>
        <button
          type="button"
