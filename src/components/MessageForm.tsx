    ...
    <div className="flex flex-col items-center text-center  h-fit text-[#121212] rounded-md gap-3 w-full  ">
      ...
      >
        ...
        <Textarea
          ...
          id="message"
          placeholder="Message"
          className="border p-4   w-full focus:outline-none focus:ring focus:ring-blue-500 min-h-[250px] md:min-h-[300px] "
        />

        <Button
          type="submit"
          className=" text-center  py-8  text-white  px-16 rounded-md justify-center w-fit
