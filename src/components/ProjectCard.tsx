...
function ExperienceCard({
  ...
  return (
    <motion.article className="flex  flex-col w-full justify-between mx-auto rounded-md transition-all xl:flex-row ">
      <motion.div className="max-xl:mb-4 xl:mr-20 flex flex-col   justify-center gap-2 w-full xl:w-[200px] ">
