...
function ProjectCard({
  ...
  return (
    ...
    >
      <Link
        href={link}
        className="relative shadow  overflow-hidden w-full h-full min-h-[280px] lg:min-h-[400px] xl:min-h-[550px] "
        target="_blank"
      >
        <motion.img
          src={imgUrl}
          alt="card image"
          className="overflow-hidden object-cover w-full h-full min-h-[280px] lg:min-h-[400px] xl:min-h-[450px] "
        />
