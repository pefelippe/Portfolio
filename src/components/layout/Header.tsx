  ...
  return (
    <>
      <motion.header
        ...
        className="fixed z-10 flex w-full bg-[#fefefe] dark:bg-[#09090b] transition-colors duration-300"
      >
        <div className="flex mx-auto items-center justify-between w-full p-6 md:px-12">
