...
export default function About({}: Props) {
  return (
    <motion.div
      ...
      className="h-fit flex max-lg:flex-col justify-start  max-w-7xl  items-center md:gap-24 gap-8"
    >
      <motion.img
        alt="avatar-pefelippe"
        src="assets/avatar-pdr.png"
        className="relative object-cover rounded-2xl 
        max-lg:w-full max-lg:h-[250px]  h-[550px] w-[450px]  shadow-2xl"
      />

      <motion.div
        className=" text-white h-fit
        flex flex-col text-3xl justify-start text-center lg:text-start 
        gap-4 md:gap-12  w-full "
      >
