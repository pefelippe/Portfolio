...
function Contact() {
  return (
    <motion.div
      ...
      className="mx-auto flex flex-col w-full max-lg:text-center items-center lg:items-start max-lg:py-5 justify-center max-w-7xl gap-4 h-fit lg:min-h-[80vh]"
    >
      <div className="relative h-full w-full flex justify-between gap-6 lg:gap-20 max-lg:flex-col items-center ">
        <div className="relative flex flex-col justify-center lg:max-w-xl w-full h-full ">
          <div className="w-full lg:max-w-2xl  text-[#888] text-xl gap-4 flex flex-col items-center mb-4">
          ...
          <div className="flex gap-3  rounded-full text-[#222222] py-3 mx-auto ">
            <motion.img
              src="/assets/vito.jpg"
              alt="me"
