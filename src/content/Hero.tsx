  ...
  return (
    ...
    >
      <motion.div
        ...
        className="flex flex-col gap-3 justify-start h-full my-auto items-center  max-sm:max-w-md text-center
        dark:text-white "
      >
        <p className="text-3xl font-semibold text-gray-900 tracking-normal leading-[1.1]  dark:text-white">
          Hello there, I'm Pedro Felippe!
        </p>

        <span className="text-2xl dark:text-gray-300  text-[#444] max-w-2xl text-center">
