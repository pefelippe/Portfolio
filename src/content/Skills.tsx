...
function Skills({}: Props) {
  return (
    <motion.div
      ...
      className="h-fit max-w-4xl min-h-[60vh] py-10 mx-auto max-xl:px-8 text-xl  rounded-md text-center 
    ...
    >
      ...
      <motion.div
        ...
        className="gap-10  grid w-fit grid-cols-3 md:grid-cols-6  mx-auto py-5 "
      >
