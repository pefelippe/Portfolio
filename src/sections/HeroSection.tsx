...
function HeroSection() {
  return (
    ...
    >
      <motion.div
        className="flex flex-col items-start justify-center w-full h-full gap-5 mx-auto "
        initial={{ opacity: 0, y: 50 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 1, delay: 0.25 }}
      >
        <motion.span className="text-4xl md:text-7xl  font-semibold  lg:leading-[1.1]">
        ...
        <motion.span
          ...
          className="text-lg md:text-xl font-medium mb-0 text-[#8c929a] lg:max-w-lg "
        >
